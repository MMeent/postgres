...
extern PGDLLIMPORT const char *Unix_socket_group;
extern PGDLLIMPORT const char *Unix_socket_directories;
extern PGDLLIMPORT const char *ListenAddresses;
...
extern PGDLLIMPORT const char *bonjour_name;
